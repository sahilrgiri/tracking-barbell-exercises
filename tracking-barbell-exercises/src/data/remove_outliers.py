...
df[outliers_columns[3:6] + ["label"]].boxplot(by = "label", figsize=(20,10), layout = (1,3))
...
df[outliers_columns[3:6] + ["label"]].plot.hist(by = "label", figsize=(20,20), layout = (3,3))
...
for col in outliers_columns:
    for label in df["label"].unique():
        ...
        #Update the column to original df 
...
#some column have nan values   eg-  acc_x: 9005 non null and 4 null
